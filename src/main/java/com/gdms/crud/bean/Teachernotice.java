...
public class Teachernotice {
	...
	public String toString() {
		return "Teachernotice [noticeid=" + noticeid + ", noticetitle=" + noticetitle + ", notifier=" + notifier
				+ ", declaretime=" + declaretime + ", fjname=" + fjname + ", fjpath=" + fjpath + ", jszbh=" + jszbh
				+ ", readornot=" + readornot + ", noticecontent=" + noticecontent + "]";
	}
