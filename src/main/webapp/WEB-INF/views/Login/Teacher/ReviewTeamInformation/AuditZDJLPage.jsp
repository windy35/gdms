...
<!-- 自定义JS文件 -->
<script type="text/javascript" src="${APP_PATH}/static/js/Teacher/AuditZDJL.js"></script>
<!-- 自定义CSS文件 -->
...
<span class="HeadTitle">(教师)审核指导记录</span>
<ul>
<li>
...
<table border="1" id="SHQK">
	<tr>
	<td>
	<span>指导教师指导记录审核意见：</span>
	</td>
	<td>
		<select id="zdjlinstructoropinion" name="zdjlinstructoropinion">
	...
	<tr>
	<td>	
		<span>指导教师指导记录审核详细意见：<br>已输入<span id="zdjlinstructordetailopinionzs" class="zs"></span>个字符</span>
	</td>
	<td>				
		<textarea rows="5" cols="80"  id="zdjlinstructordetailopinion" name="zdjlinstructordetailopinion" style="resize: none;"></textarea>
		<span class="help-block" style="display:inline"></span>
	</td>
	</tr>
	</table>	
