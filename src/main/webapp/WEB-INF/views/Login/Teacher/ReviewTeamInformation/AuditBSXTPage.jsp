...
<body>
<span class="HeadTitle">（教师）审核毕设选题信息</span>
<ul>
<li>
...
<!-- 毕设选题审核情况 -->
<li>
	<span class="start"></span><strong class="text"> 毕设选题审核意见</strong>
</li>
<li>
<form id="AuditBSXTForm">
<table border="1" id="SHQK">
	<tr>
	<td>
	<span>指导教师毕设选题审核意见：</span>
	</td>
	<td>
		<select id="bsxtyj" name="bsxtinstructoropinion">
	...
	<tr>
	<td>	
		<span>指导教师毕设选题审核详细意见：<br>已输入<span id="zdjsbsxtxxyjzs" class="zs"></span>个字符</span>
	</td>
	<td>				
		<textarea rows="5" cols="80"  id="bsxtxxyj" name="bsxtinstructordetailopinion" style="resize: none;"></textarea>
		<span class="help-block" style="display:inline"></span>
	</td>
	</tr>
	</table>
		<input type="hidden" value="${requestScope.gdresultID}" id="graduationdesignresultid">
