...
<!-- 自定义JS文件 -->
<script type="text/javascript" src="${APP_PATH}/static/js/Teacher/AuditZQJCB.js"></script>
<!-- 自定义CSS文件 -->
...
<span class="HeadTitle">(教师)审核中期检查表</span>
<ul>
<li>
...
<table border="1" id="SHQK">
	<tr>
	<td>
	<span>指导教师中期检查表审核意见：</span>
	</td>
	<td>
		<select id="zqjcbinstructoropinion" name="zqjcbinstructoropinion">
	...
	<tr>
	<td>	
		<span>指导教师中期检查表审核详细意见：<br>已输入<span id="zqjcbinstructordetailopinionzs" class="zs"></span>个字符</span>
	</td>
	<td>				
		<textarea rows="5" cols="80"  id="zqjcbinstructordetailopinion" name="zqjcbinstructordetailopinion" style="resize: none;"></textarea>
		<span class="help-block" style="display:inline"></span>
	</td>
	</tr>
	</table>
