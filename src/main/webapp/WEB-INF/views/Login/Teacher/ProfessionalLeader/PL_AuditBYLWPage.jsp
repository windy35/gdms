...
<!-- 自定义JS文件 -->
<script type="text/javascript" src="${APP_PATH}/static/js/Teacher/PL_AuditBYLW.js"></script>
<!-- 自定义CSS文件 -->
...
<span class="HeadTitle">（专业负责人）审核毕业论文详细信息</span>
<ul>
<li>
...
<form id="AuditBYLWForm">
	<table class="tablestyle" border="1" id="SHQK">
		<tr>
			...
			<td>
			<p class="txt_left_top">审核状态：${requestScope.gdresult.bylwinstructoropinion}</p>
			</td>			
		</tr>
		<tr>
			<td>
			<p class="txt_left_top">审核意见：${requestScope.gdresult.bylwinstructordetailopinion}</p>
			<p class="txt_right_bottom">审核人：${requestScope.gdresult.bylwinstructorshr}&nbsp;&nbsp;&nbsp;&nbsp;审核时间：${requestScope.gdresult.bylwinstructordeclaretime}</p>
			</td>		
		</tr>		
	<tr>
	<td rowspan="2" width="10%">
	...
	<td>
			毕业论文审核意见：
			<select id="bylwexpertopinion" name="bylwexpertopinion">
	...
	<tr>
	<td>
			<span>专业负责人毕业论文审核详细意见：已输入<span id="bylwexpertdetailopinionzs" class="zs"></span>个字符</span>
			<br>
			<textarea rows="5" cols="80"  id="bylwexpertdetailopinion" style="resize: none;" name="bylwexpertdetailopinion"></textarea>
			<span class="help-block" style="display:inline"></span>		
	</td>	
	</tr>
	<tr>
