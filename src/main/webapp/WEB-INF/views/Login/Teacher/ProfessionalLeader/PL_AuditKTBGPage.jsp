...
<!-- 自定义JS文件 -->
<script type="text/javascript" src="${APP_PATH}/static/js/Teacher/PL_AuditKTBG.js"></script>
...
<title>（专业负责人）审核开题报告</title>
</head>
<body>
<span class="HeadTitle">（专业负责人）审核开题报告</span>
<ul>
<li>
...
<form id="AuditKTBGForm">
	<table class="tablestyle" border="1" id="SHQK">
		<tr>
			...
			<td>
			<p class="txt_left_top">审核状态：${requestScope.gdresult.ktbginstructoropinion}</p>
			</td>			
		</tr>
		<tr>
			<td>
			<p class="txt_left_top">审核意见：${requestScope.gdresult.ktbginstructordetailopinion}</p>
			<p class="txt_right_bottom">审核人：${requestScope.gdresult.ktbginstructorshr}&nbsp;&nbsp;&nbsp;&nbsp;审核时间：${requestScope.gdresult.ktbginstructordeclaretime}</p>
			</td>		
		</tr>		
	<tr>
	<td rowspan="2" width="10%">
	...
	<td>
			开题报告审核意见：
			<select id="ktbgexpertopinion" name="ktbgexpertopinion">
	...
	<tr>
	<td>
			<span>专业负责人开题报告审核详细意见：已输入<span id="ktbgexpertdetailopinionzs" class="zs"></span>个字符</span>
			<br>
			<textarea rows="5" cols="80"  id="ktbgexpertdetailopinion" style="resize: none;" name="ktbgexpertdetailopinion"></textarea>
			<span class="help-block" style="display:inline"></span>		
	</td>	
	</tr>
	<tr>
