...
<!-- 自定义JS文件 -->
<script type="text/javascript" src="${APP_PATH}/static/js/Teacher/PL_AuditWWYWHYJ.js"></script>
<!-- 自定义CSS文件 -->
...
<span class="HeadTitle">（专业负责人）审核外文译文和原件</span>
<ul>
<li>
...
<li>
	...
	<table class="tablestyle" border="1" id="SHQK">
		<tr>
			...
			<td>
			<p class="txt_left_top">审核状态：${requestScope.gdresult.wwywhyjinstructoropinion}</p>
			</td>			
		</tr>
		<tr>
			<td>
			<p class="txt_left_top">审核意见：${requestScope.gdresult.wwywhyjinstructordetailopinion}</p>
			<p class="txt_right_bottom">审核人：${requestScope.gdresult.wwywhyjinstructorshr}&nbsp;&nbsp;&nbsp;&nbsp;审核时间：${requestScope.gdresult.wwywhyjinstructordeclaretime}</p>
			</td>		
		</tr>		
	<tr>
	<td rowspan="2" width="10%">
	...
	<td>
			外文译文和原件审核意见：
			<select id="wwywhyjexpertopinion" name="wwywhyjexpertopinion">
	...
	<tr>
	<td>
			<span>专业负责人外文译文和原件审核详细意见：已输入<span id="wwywhyjexpertdetailopinionzs" class="zs"></span>个字符</span>
			<br>
			<textarea rows="5" cols="80"  id="wwywhyjexpertdetailopinion" style="resize: none;" name="wwywhyjexpertdetailopinion"></textarea>
			<span class="help-block" style="display:inline"></span>		
	</td>	
	</tr>
	<tr>
