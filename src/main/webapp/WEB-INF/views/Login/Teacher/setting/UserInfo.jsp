...
<!-- 自定义js文件 -->
    ...
    <script type="text/javascript" src="${APP_PATH}/static/js/Teacher/alertUserInfo.js"></script> 
<!--网页小图标-->
	<link rel="shortcut icon" href="${APP_PATH}/static/images/logo.png" type="image/x-icon">
</head>
<body>
<span class="HeadTitle">修改教师用户信息</span>
<div id="alertUserInfoDiv">
	<form action="">
			<ul>
				...
				<li class="li_font">
					 <span>院系：</span>			
					${sessionScope.user.department.departmentname}
				</li>												
				<li class="li_font">
					  <span>手机号码：</span>
