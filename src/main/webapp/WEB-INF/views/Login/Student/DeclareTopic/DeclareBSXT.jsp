...
<!-- 自定义JS文件 -->
<script type="text/javascript" src="${APP_PATH}/static/js/Student/DeclareBSXT.js"></script>
<!-- 自定义CSS文件 -->
<link href="${APP_PATH}/static/css/form.css" rel="stylesheet">

<title>（学生）申报毕设信息</title>
</head>
<body>
<span class="HeadTitle">（学生）申报毕设选题</span>
				<ul id="BSXT">
					<li>
						<span id="bstmTitle">毕设题目：已输入<span id="bstmzs" class="zs"></span>个字符</span>
					</li>
					<li>
					...
					<li>											 
						<span>所属院系：</span>	
						<span>${sessionScope.user.classes.department.departmentname}</span>
					</li>
					<li>						
						<span>所属专业：</span>
						<span>${sessionScope.user.classes.major.majorname}</span>							 
					</li>
					<li>				
					...
					<li>										
						<span  id="dsbhTitle">导师编号及姓名：</span>
						<select id="dsbh"></select>
						<span class="help-block" style="display:inline"></span>
					</li>
					<li>
					...
					<li>								
						<span id="twyqTitle">毕业设计(论文)任务要求（包括应具备的条件）：已输入<span id="rwyqzs" class="zs"></span>个字符</span>
					</li>
					<li>						
