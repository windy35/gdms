<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"  import="com.gdms.crud.bean.Student" %>
...
<!-- 自定义js文件 -->
    ...
    <script type="text/javascript" src="${APP_PATH}/static/js/Student/alertUserInfo.js"></script>    	 
<!--网页小图标-->
...
<div id="alertUserInfoDiv">
	<form>
			<ul>
				...
				<li class="li_font">
					 <span>学号：</span>
					 ${sessionScope.user.studentid}					  	 				
				</li>
				<li class="li_font">
					 <span>院系：</span>			
					${sessionScope.user.classes.department.departmentname}					 		 					  
					  
				</li>
				<li class="li_font">
					 <span>专业：</span>
					 ${sessionScope.user.classes.major.majorname}					 		 				 					
				</li>													
				<li class="li_font">
					  <span>手机号码：</span>
