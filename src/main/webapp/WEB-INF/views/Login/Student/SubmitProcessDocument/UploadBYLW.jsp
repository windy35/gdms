...
<!-- 自定义JS文件 -->
<script type="text/javascript" src="${APP_PATH}/static/js/Student/uploadBYLW.js"></script>
<!-- 自定义CSS文件 -->
...
<span class="HeadTitle">提交毕业论文</span>
<ul>
<li>
...
<ul>
	...
	<c:if test="${empty requestScope.bylwinfo}">
	...
	<li>
		<input type="text" name="gjc" id="gjc" style="width:800px" class="form-control textinline"/>
	...
	<li>
		<textarea rows="5" cols="100" id="cxd" name="cxd" class="has-error" style="resize: none;" class="form-control textinline"></textarea>
		<span class="help-block" style="display:inline"></span>
	</li>	
	<li>
		<span class="glyphicon glyphicon-play"></span>
	...
	<li>
		<textarea rows="5" cols="100" id="zwzy" name="zwzy" class="has-error" style="resize: none;" class="form-control textinline"></textarea>
		<span class="help-block" style="display:inline"></span>
	</li>	
		<li>
		<span class="glyphicon glyphicon-play"></span>
	...
	<li>
		<textarea rows="5" cols="100" id="ywzy" name="ywzy" class="has-error" style="resize: none;" class="form-control textinline"></textarea>	    
		<span class="help-block" style="display:inline"></span>
	</li>
	<li>
		<span class="glyphicon glyphicon-play"></span>	
	...
	<li>
	        <textarea rows="3" cols="100" id="qt" name="qt" class="has-error" style="resize: none;"></textarea>	        
	        <span class="help-block" style="display:inline"></span>
	</li>													
	<li>				
			<span class="glyphicon glyphicon-play"></span>	
    ...
    <!-- 如果用户上传了相关的毕业论文则显示毕业论文信息的表格 -->
	<c:if test="${not empty requestScope.bylwinfo}">
	<li>
		<span class="HeadTitle">毕业论文审核情况</span>
	</li>
	<li>
		<!-- 显示表格数据 -->
		<div class="row">
