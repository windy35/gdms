...
<!-- 自定义JS文件 -->
<script type="text/javascript" src="${APP_PATH}/static/js/Student/uploadKTBG.js"></script>
<!-- 自定义CSS文件 -->
...
<span class="HeadTitle">提交开题报告</span>
<ul>
<li>
...
<ul>
	...
	<!-- 如果用户没有上传开题报告信息则显示相关的表单 -->	
	<c:if test="${empty requestScope.ktbginfo}">
	<li>
	    <form enctype="multipart/form-data" id="ktbgForm">	    
	    <input type="hidden" name="graduationdesignid" id="gdidhidden" value="${requestScope.GDInfo.graduationdesignid}">	   	    
	     <span class="start"></span><strong class="text" id="ktbgdetailTitle">请输入开题报告的详情开题申请（包括选题的意义与目的、文献综述、研究现状、创新思路、论文提纲、进度安排、参考文献等）</strong>
	     	<br>
	     	<span>已输入<span id="ktbgDetailzs" class="zs"></span>个字符</span>	
	    	<br>	    	
	        <textarea rows="15" cols="100" id="ktbgdetail" name="ktbgdetail"  class="has-error textinline" style="resize: none;"></textarea>
	        <span class="help-block" style="display:inline"></span>			
	        <br><label>请选择需要上传的开题报告</label>
	...
	<c:if test="${not empty requestScope.ktbginfo}">
	<li>
		<span class="HeadTitle">开题报告审核情况</span>
	</li>
	<li>
		<!-- 显示表格数据 -->
		<div class="row">
