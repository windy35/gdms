...
<!-- 自定义JS文件 -->
<script type="text/javascript" src="${APP_PATH}/static/js/Student/AlertKTBG.js"></script>
<!-- 自定义CSS文件 -->
...
<ul>
	...
	<li>
	    ...
	    <input type="hidden" name="graduationdesignid" id="gdidhidden" value="${requestScope.GDInfo.graduationdesignid}">	   	    
	     <span class="start"></span><strong class="text">请输入开题报告的详情开题申请（包括选题的意义与目的、文献综述、研究现状、创新思路、论文提纲、进度安排、参考文献等）</strong>
	    	<br>	    	
	        <textarea rows="15" cols="100" id="ktbgdetail" name="ktbgdetail" class="has-error" style="resize: none;">${requestScope.ktbgInfo.ktbgdetail}</textarea>
	        <span class="help-block" style="display:inline"></span>
	        <br>
	        <span>已输入<span id="ktbgDetailzs" class="zs"></span>个字符</span>				
	        <br>
	        <span class="glyphicon glyphicon-play">添加附件：请选择需要上传的开题报告</span>
	        <input type="file" name="files" accept=".doc" id="files">
	        <input type="hidden" name="ktbginfoid" value="${requestScope.ktbgInfo.ktbginfoid}">
