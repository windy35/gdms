...
<!-- 自定义JS文件 -->
<script type="text/javascript" src="${APP_PATH}/static/js/Student/uploadDBPPT.js"></script>
<!-- 自定义CSS文件 -->
...
<span class="HeadTitle">提交答辩PPT</span>
<ul>
<li>
...
<ul>
	...
	<c:if test="${empty requestScope.dbpptinfo}">
	...
	<li>
		<input type="text" name="title" id="title" style="width:800px" class="form-control textinline"/>
	...
	<li>
		<textarea rows="5" cols="100" id="nrzy" name="nrzy" class="has-error" style="resize: none;" class="form-control textinline"></textarea>
		<span class="help-block" style="display:inline"></span>
	</li>	
	<li>				
			<span class="glyphicon glyphicon-play"></span>	
    ...
    <!-- 如果用户上传了相关的答辩PPT则显示答辩PPT信息的表格 -->
	<c:if test="${not empty requestScope.dbpptinfo}">
	<li>
		<span class="HeadTitle">答辩PPT审核情况</span>
	</li>
	<li>
		<!-- 显示表格数据 -->
		<div class="row">
