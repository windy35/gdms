...
<!-- 自定义JS文件 -->
<script type="text/javascript" src="${APP_PATH}/static/js/Student/AlertWWYWHYJ.js"></script>
<!-- 自定义CSS文件 -->
...
<span class="HeadTitle">修改外文译文和原件</span>
<ul>
<li>
...
<ul>
	...
	<tr>
		<td>
			...
			<span class="title2" id="wwywnrTitle">外文译文内容  共输入 <span id="wwywnrzs" class="zs"></span>个字符</span>
			<span class="title3">请按照学校的要求提交外文译文，若无内容请填“无”</span>
			<textarea rows="10" cols="80" id="wwywnr" name="wwywnr" class="has-error" style="resize: none;" class="form-control textinline">${requestScope.wwywhyjinfo.wwywnr}</textarea>
	        <span class="help-block" style="display:inline"></span>					
		</td>	    
		<td>
			<span class="glyphicon glyphicon-play" style="padding-left:10px"></span>
			<span class="title2" id="ywnrTitle">原文内容  共输入 <span id="ywnrzs" class="zs"></span>个字符</span>
			<span class="title3">请按照学校的要求提交原文内容，若无内容请填“无”</span>
			<textarea rows="10" cols="80" id="ywnr" name="ywnr" class="has-error" style="resize: none;" class="form-control textinline">${requestScope.wwywhyjinfo.ywnr}</textarea>
	        <span class="help-block" style="display:inline"></span>							
		</td>		
	</tr>
	<tr>
