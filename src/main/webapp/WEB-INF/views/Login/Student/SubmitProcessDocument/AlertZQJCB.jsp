...
<!-- 自定义JS文件 -->
<script type="text/javascript" src="${APP_PATH}/static/js/Student/AlertZQJCB.js"></script>
<!-- 自定义CSS文件 -->
...
<span class="HeadTitle">修改中期检查表</span>
<ul>
<li>
...
<ul>
	...
	<li>
		<input type="text" name="qzrq" id="qzrq" value="${requestScope.zqjcbinfo.qzrq}" style="width:800px" class="form-control textinline"/>
	...
	<li>
	        <textarea rows="10" cols="80" id="xtbhyy" name="xtbhyy" class="has-error" style="resize: none;" class="form-control textinline">${requestScope.zqjcbinfo.xtbhyy}</textarea>
	        <span class="help-block" style="display:inline"></span>
	</li>
	<li>
		<span class="glyphicon glyphicon-play"></span>	
	...
	<li>
	        <textarea rows="10" cols="80" id="jdzhyy" name="jdzhyy" class="has-error" style="resize: none;">${requestScope.zqjcbinfo.jdzhyy}</textarea>
	        <span class="help-block" style="display:inline"></span>
	</li>
	<li>
		<span class="glyphicon glyphicon-play"></span>	
	...
	<li>
			<input type="text" class="has-error" id="zdcs" name="zdcs" value="${requestScope.zqjcbinfo.zdcs}">
	        <span class="help-block" style="display:inline"></span>
	</li>
	<li>
		<span class="glyphicon glyphicon-play"></span>	
	...
	<li>
	        <textarea rows="10" cols="80" id="qt" name="qt" class="has-error" style="resize: none;">${requestScope.zqjcbinfo.qt}</textarea>
	        <span class="help-block" style="display:inline"></span>
	</li>													
	<li>				
			<span class="glyphicon glyphicon-play"></span>	
