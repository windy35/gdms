...
<span class="HeadTitle">中期检查表详细信息</span>
<ul>
<li>
...
<ul>
	...
	<li>	  	        
	        ...
	        <span><a href="download?path=${requestScope.zqjcbinfo.fjpath}&fileName=${requestScope.zqjcbinfo.fjname}">下载文件</a></span>
	</li>
	</c:if>
	<c:if test="${not empty requestScope.GDResultInfo.zqjcbinstructoropinion}">
		<li>
			...
			<table class="tablestyle" border="1">
				<c:if test="${not empty requestScope.GDResultInfo.zqjcbinstructoropinion}">
					<tr>
						...
						<td>
						<p class="txt_left_top">审核状态：${requestScope.GDResultInfo.zqjcbinstructoropinion}</p>
						</td>			
					</tr>
					<tr>
						<td>
						<p class="txt_left_top">审核意见：${requestScope.GDResultInfo.zqjcbinstructordetailopinion}</p>
						<p class="txt_right_bottom">审核人：${requestScope.GDResultInfo.zqjcbinstructorshr}&nbsp;&nbsp;&nbsp;&nbsp;审核时间：${requestScope.GDResultInfo.zqjcbinstructordeclaretime}</p>
						</td>		
					</tr>		
				</c:if>	
				<c:if test="${not empty requestScope.GDResultInfo.zqjcbexpertopinion}">	
				<tr>
						<td rowspan="2" width="10%">
						专业负责人审核意见
						</td>
						<td>
						<p class="txt_left_top">审核状态：${requestScope.GDResultInfo.zqjcbexpertopinion}</p>
						</td>			
					</tr>
					<tr>
						<td>
						<p class="txt_left_top">审核意见：${requestScope.GDResultInfo.zqjcbexpertdetailopinion}</p>
						<p class="txt_right_bottom">审核人：${requestScope.GDResultInfo.zqjcbexpertshr}&nbsp;&nbsp;&nbsp;&nbsp;审核时间：${requestScope.GDResultInfo.zqjcbexpertdeclaretime}</p>
						</td>		
					</tr>	
					</c:if>			
				</table>		
