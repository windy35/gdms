...
<!-- 自定义js文件 -->
	...
	<script type="text/javascript" src="${APP_PATH}/static/js/NoticeDetail2.js"></script>    
<!--网页小图标-->
...
<a href="JumpNoticeDetail2?noticeid=${requestScope.PreviewDetail.noticeid}">${requestScope.PreviewDetail.noticetitle}</a>
</c:if>
...
<a href="JumpNoticeDetail2?noticeid=${requestScope.NextDetail.noticeid}">${requestScope.NextDetail.noticetitle}</a>
</c:if>
