...
function build_dbppt_table(result){	
	//清空table表格中的数据
	$("#Table tbody").empty();
	...
	$.each(gds,function(index,item){
		...
		if(item.dbpptinfo != null)
		var uploadtimeTd = $("<td></td>").append(item.dbpptinfo.uploadtime);
		if(item.dbpptauditstatus != null)
		var dbpptauditstatusnameTd = $("<td></td>").append(item.dbpptauditstatus.auditstatusname);
		...
		var dbpptinfoHidden =  $("<td></td>").append($("<input></input>").attr("type","hidden").attr("value",item.dbpptinfoid).attr("id","dbpptinfoHidden"));
		...
		.append(dbpptauditstatusnameTd)
		.append(uploadtimeTd)
		.append(checkBtn)
		.append(updateBtn)
		.append(gdResultIdHidden)
		.append(dbpptinfoHidden)
...
$(function(){
	$(document).on("click",".check_btn",function(){		
		...
		var dbpptinfoid = $("#dbpptinfoHidden").val();
		var gdResultID = $("#gdResultIdHidden").val();
		window.location.href = "JumpDBPPTDetailPages?gdID="+gdID+"&gdResultID=" + gdResultID+"&dbpptinfoid=" + dbpptinfoid;
});
});
...
$(function(){
	$(document).on("click",".update_btn",function(){
		var dbpptinfoid = $("#dbpptinfoHidden").val();
		window.location.href="JumpAlertDBPPTPage?dbpptinfoid=" + dbpptinfoid;
});
});
