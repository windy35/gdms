...
function build_zdjl_table(result){	
	//清空table表格中的数据
	$("#Table tbody").empty();
	...
	$.each(gds,function(index,item){
		...
		if(item.zdjlinfo != null)
		var uploadtimeTd = $("<td></td>").append(item.zdjlinfo.uploadtime);
		if(item.zdjlauditstatus != null)
		var zdjlauditstatusnameTd = $("<td></td>").append(item.zdjlauditstatus.auditstatusname);
		...
		var zdjlinfoHidden =  $("<td></td>").append($("<input></input>").attr("type","hidden").attr("value",item.zdjlinfoid).attr("id","zdjlinfoHidden"));
		...
		.append(zdjlauditstatusnameTd)
		.append(uploadtimeTd)
		.append(checkBtn)
		.append(updateBtn)
		.append(gdResultIdHidden)
		.append(zdjlinfoHidden)
...
$(function(){
	$(document).on("click",".check_btn",function(){		
		...
		var zdjlinfoid = $("#zdjlinfoHidden").val();
		var gdResultID = $("#gdResultIdHidden").val();
		window.location.href = "JumpZDJLDetailPages?gdID="+gdID+"&gdResultID=" + gdResultID+"&zdjlinfoid=" + zdjlinfoid;
});
});
...
$(function(){
	$(document).on("click",".update_btn",function(){
		var zdjlinfoid = $("#zdjlinfoHidden").val();
		window.location.href="JumpAlertZDJLPage?zdjlinfoid=" + zdjlinfoid;
});
});
